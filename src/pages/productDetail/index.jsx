...
const Product = () => {
  ...
  return (
    <section className="p-[30px] rounded-xl relative">
      <p
        onClick={() => navigate(-1)}
        className="absolute left-[80px] flex items-center gap-[2px] text-[17px] cursor-pointer hover:text-green-500"
      >
        ...
        <div className="grid grid-cols-2 bg-white rounded-xl">
          ...
          <div className="p-[20px] flex flex-col gap-[25px]">
            ...
            <div className="flex items-center gap-[30px]">
              <button className="bg-[#000] self-start font-sans font-medium hover:bg-[#1fba4a] text-[#fff] flex items-center gap-[10px] p-[8px_100px] rounded-[6px] cursor-pointer active:scale-95 transition duration-[.2s]">
                <ShoppingCartOutlined /> Savatchaga
              </button>
              <p
                className={`flex items-center gap-[5px] font-medium font-sans ${
              ...
              <div className="grid grid-cols-4 gap-[10px]">
                {["#576755", "#adc5db", "#fae8d1", "#dedddd"].map(
                  (color, index) => (
                    <div
                      key={index}
                      className="p-[10px] hover:border-[#1fba4a] cursor-pointer rounded-xl border border-[#f6f8fa] flex flex-col gap-[3px] items-center"
                    >
                      <span
            ...
            <div className="flex items-center gap-[10px] bg-[#e9f8ed] p-[10px] rounded-md">
              <img src={uzb} alt="uzb" />
